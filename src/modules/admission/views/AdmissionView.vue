...
<template>
  <div class="space-y-6">
    <!-- Heading -->
    <div>
      <h2 class="text-2xl font-bold text-[#04395a]">Admisión</h2>
      <p class="text-sm text-gray-500 mt-0.5">Gestión de importaciones y registro de estudiantes.</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div class="px-6 pb-6">
        ...
        <div v-show="activeTab === 'import'" class="mt-2 space-y-5">
          ...
          <div v-if="parsedStudents.length > 0 || stage === 'importing' || stage === 'done'" class="space-y-4">
